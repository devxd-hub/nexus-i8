...
export const NexusReversePinwheel: React.FC<NexusReversePinwheelProps> = ({ rowRef }) => {
  ...
  return (
    <motion.div
      ...
      className="nexus-reverse-pinwheel relative inline-flex items-center justify-start -ml-2 sm:-ml-4 md:-ml-8 lg:-ml-12 z-20 pointer-events-auto select-none will-change-transform"
      aria-hidden="true"
    >
      <style>{`
      ...
      <div
        ...
        className={`w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-40 lg:h-40 xl:w-44 xl:h-44 cursor-pointer rounded-[28px] transition-transform duration-300 aspect-square flex items-center justify-center ${
      ...
      >
        <svg
          ...
          className="w-full h-full block nexus-reverse-pinwheel-svg"
        >
