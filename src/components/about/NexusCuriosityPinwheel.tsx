...
export const NexusCuriosityPinwheel: React.FC<NexusCuriosityPinwheelProps> = ({ rowRef }) => {
  ...
  return (
    <motion.div
      ...
      className="relative inline-flex items-center justify-start z-20 pointer-events-auto select-none will-change-transform"
      aria-hidden="true"
    >
      <div
        ...
        className={`nexus-pinwheel-card w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-40 lg:h-40 xl:w-44 xl:h-44 cursor-pointer transition-transform duration-300 ${
      ...
      >
        <svg
          ...
          className="nexus-pinwheel-svg w-full h-full block text-[var(--text-primary)] overflow-visible"
          style={{
