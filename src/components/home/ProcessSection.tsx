...
export const ProcessSection: React.FC = () => {
  ...
  return (
    <RevealSection
      ...
      className="relative w-full py-14 sm:py-18 md:py-22 bg-[#EBE5DB] border-b border-[rgba(10,10,9,0.12)] overflow-hidden"
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="max-w-4xl mb-8 sm:mb-12 space-y-3 sm:space-y-4">
          ...
          <p className="font-bitter text-[#66615A] max-w-2xl text-base sm:text-lg pt-1 leading-relaxed">
