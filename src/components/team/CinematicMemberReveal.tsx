...
export const CinematicMemberReveal: React.FC<CinematicMemberRevealProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-full flex items-center justify-center overflow-hidden border-b border-[rgba(245,239,230,0.10)] min-h-[90vh] lg:min-h-screen py-16 sm:py-24 bg-[#0C0C0C] text-[#F5EFE6] px-4 sm:px-8 md:px-12 lg:px-16"
    >
      {/* Background Subtle Watermark Index */}
      <div
        className="absolute top-1/2 -translate-y-1/2 right-4 sm:right-16 font-dosis font-bold text-[22vw] text-[#F5EFE6]/[0.025] pointer-events-none select-none tracking-tighter"
        aria-hidden="true"
      >
        {paddedIndex}
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="absolute top-3 left-3 w-3 h-3 border-t border-l border-[#F2613F]" />
            <div className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-[#F2613F]" />
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <span className="px-2.5 py-1 bg-[#181818] border border-[rgba(242,97,63,0.3)] text-[#F5EFE6] font-dosis text-xs font-bold tracking-[0.22em] uppercase">
          ...
          <motion.div style={{ opacity: roleOpacity }} className="space-y-1">
            ...
            <motion.h3
              ...
              className="font-fraunces font-bold text-3xl sm:text-4xl md:text-5xl text-[#F5EFE6] tracking-tight leading-[1.08]"
            >
              {member.name}
            </motion.h3>
          </motion.div>
          ...
          <motion.p
            ...
            className="font-bitter text-base sm:text-lg text-[#C2BBB0] leading-relaxed max-w-lg"
          >
            {oneLineDescriptor}
          </motion.p>
