...
export const EditorialMentorHero: React.FC<EditorialMentorHeroProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-full min-h-[92vh] lg:min-h-screen py-24 sm:py-32 bg-[#EBE4D8] text-[#0A0A09] flex items-center justify-center border-b border-[#0A0A09]/15 px-4 sm:px-8 md:px-12 lg:px-16 overflow-hidden select-none"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="space-y-1">
            <span className="block font-dosis font-bold text-xs sm:text-sm tracking-[0.26em] text-[#EF5A2A] uppercase">
              ADVISORY &amp; GUIDANCE
            </span>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-[#0A0A09]/15 pt-4 text-left">
            <div>
              <span className="block text-[9px] font-dosis font-bold tracking-[0.2em] text-[#66615A] uppercase">
                AREA OF ADVISORY
              </span>
              <span className="font-dosis font-bold text-xs text-[#0A0A09] block mt-0.5">
                {member.discipline}
              </span>
            </div>
            <div>
              ...
              <span className="font-dosis font-bold text-xs text-[#EF5A2A] block mt-0.5">
                {member.role}
              </span>
            </div>
          </div>
